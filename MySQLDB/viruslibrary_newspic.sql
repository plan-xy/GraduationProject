...
CREATE TABLE `newspic` (
  ...
  PRIMARY KEY (`picid`),
  KEY `news_newspic_idx` (`newsid`),
  CONSTRAINT `newspk` FOREIGN KEY (`newsid`) REFERENCES `news` (`newsid`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `newspic` VALUES (1,3,'https://img.400511.net/2022/02/20/4yKbmN3a.jpg',0,NULL),(3,4,'bug21',0,NULL);
